...
num_sc_wise = [0 for i in range(50)]
for i in range(num_samples):
	mx_sec = max(mx_sec , scMeta['section-end'][i]-scMeta['section-start'][i])
	num_sc_wise[(scMeta['section-end'][i]-scMeta['section-start'][i])//10] += 1
print("number of papers (no. of sections wise [with batches of 10 sections]) : \n			",num_sc_wise)

...
print("[0-9]	=	%.2f %" % (num_sc_wise[0]/num_samples))
print("[10-19]	=	%.2f %" % (num_sc_wise[1]/num_samples))
print("[20-29]	=	%.2f %" % (num_sc_wise[2]/num_samples))
print("[30-39]	=	%.2f %" % (num_sc_wise[3]/num_samples))
print("[REST]	=	%.2f %" % (num_sc_wise[4]/num_samples))
print("==================================================\n")
...
print("[0-9]	=	%.2f %" % (num_snt_wise[0]/num_sections))
print("[10-19]	=	%.2f %" % (num_snt_wise[1]/num_sections))
print("[20-29]	=	%.2f %" % (num_snt_wise[2]/num_sections))
print("[30-39]	=	%.2f %" % (num_snt_wise[3]/num_sections))
print("[REST]	=	%.2f %" % (num_snt_wise[4]/num_sections))
print("=====================================================\n")
